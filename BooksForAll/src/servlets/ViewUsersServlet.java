		...
		try {
    		...
    		Collection<UserInfo> userInfos = new ArrayList<UserInfo>();
    			try {
    				...
    				while(rs.next()) {
    					userInfos.add(new UserInfo(rs.getString(1),"","user",rs.getString(2),rs.getString(3),rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8), rs.getString(9), rs.getString(10)));
    				}	
    				rs.close();
    				stmt.close();
